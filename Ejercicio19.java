...
public class Ejercicio19{
    public static void main(String[] args) {
        System.out.println("Este programa une los dos ejercicio anteriores");
        String resultado = "";
        ...
        */
        public static long binarioADecimal(long binario) {
            long decimal = 0;
            int bits = varias.ContDigitos(binario);
            for(int i = 0; i < bits; i++) {
                decimal += varias.Dígito((int)binario, bits - i - 1) * varias.Potencia(2, i);
            }
            return decimal;
        }
        /**
        ...
        */
        public static long octalABinario(long octal) {
            long binario = 0;
            for (int i = 0; i < varias.Dígito((int)octal, i); i++) {
                binario = binario * 1000 + decimalABinario(varias.Dígito((int)octal, i));
            }
            return binario;
        }
        /**
